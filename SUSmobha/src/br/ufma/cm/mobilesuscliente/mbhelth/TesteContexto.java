...
public class TesteContexto {
	...
	public static void init(android.content.Context contexto, InputStream inp) {
		...
		try {
			mobhaContext = MOBHAContext.getInstance(inp, contexto, idUM);
			...
			new Thread(new Runnable() {
				...
				public void run() {
					try {
						...
						if (mobhaContext != null) {
							// mobhaContext
							// .addContextProviderRepository(
							// "http://lsd.ufma.br/~dejailson/MobileHealthNet/contextProviders/ContextProviders.apk",
							// "http://lsd.ufma.br/~dejailson/MobileHealthNet/contextProviders/ContextProviders.apk.desc");
							//
							mobhaContext
									.addContextProviderRepository(
											"http://200.137.131.192/~dejailson/MobileHealthNet/contextProviders/ContextProviders.apk",
											"http://200.137.131.192/~dejailson/MobileHealthNet/contextProviders/ContextProviders.apk.desc");
							//
							// mobhaContext
							// .addContextProviderRepository(
							// "http://www.devsi.com.br/mbhealth/ContextProviders.apk",
							// "http://www.devsi.com.br/mbhealth/ContextProviders.apk.desc");
							//
						}
	...
	public static void acceptRequest(boolean accept,
			ContextInformationSubscribe subscribe) {
		...
		System.out.println("Nome:" + subscribe.requestedUserName);
		System.out.println(subscribe.contextInformationInterest + ":"
				+ subscribe.requestorUserName);
		try {
